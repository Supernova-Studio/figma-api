...
var Api = /** @class */ (function () {
    function Api(params) {
        ...
        this.streamRequest = function (url, opts) { return __awaiter(_this, void 0, void 0, function () {
            var headers, axiosParams, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        headers = {};
                        this.appendHeaders(headers);
                        axiosParams = __assign({ url: url }, opts, { headers: headers, responseType: 'stream' });
                        return [4 /*yield*/, axios_1.default(axiosParams)];
                    case 1:
                        res = _a.sent();
                        if (Math.floor(res.status / 100) !== 2)
        ...
        this.headFile = api_funcs_1.headFileApi;
        this.getFile = api_funcs_1.getFileApi;
        this.getFileFull = api_funcs_1.getFileFullApi;
        this.getFileNodes = api_funcs_1.getFileNodesApi;
        this.getFileStream = api_funcs_1.getFileStreamApi;
        ...
        this.getFileComponentsStream = api_funcs_1.getFileComponentsStreamApi;
        ...
        this.getFileStylesStream = api_funcs_1.getFileStylesStreamApi;
...
function getFileApiOptionsToQueryString(opts) {
    return utils_1.toQueryParams(__assign({}, opts, { ids: opts && opts.ids && opts.ids.join(",") }));
}
function getFileApi(
/**
...
fileKey, opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, this.request(config_1.API_DOMAIN + "/" + config_1.API_VER + "/files/" + fileKey + "?" + queryParams)];
        });
    });
}
...
fileKey, opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            queryParams = getFileApiOptionsToQueryString(opts);
            return [2 /*return*/, this.streamRequest(config_1.API_DOMAIN + "/" + config_1.API_VER + "/files/" + fileKey + "?" + queryParams)];
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    queryParams = getFileApiOptionsToQueryString(opts);
                    return [4 /*yield*/, this.request(config_1.API_DOMAIN + "/" + config_1.API_VER + "/files/" + fileKey + "?" + queryParams, {
                            method: "GET",
                            fullResponse: true,
                        })];
                case 1:
...
fileKey, opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    queryParams = utils_1.toQueryParams(opts);
                    return [4 /*yield*/, this.request(config_1.API_DOMAIN + "/" + config_1.API_VER + "/files/" + fileKey + "?" + queryParams, {
                            method: "HEAD",
                            fullResponse: true,
                        })];
...
function getVersionsApi(fileKey, after, before, pageSize) {
    ...
    var queryParams = utils_1.toQueryParams({ before: before, after: after, page_size: pageSize });
    return this.request(config_1.API_DOMAIN + "/" + config_1.API_VER + "/files/" + fileKey + "/versions?" + queryParams);
}
...
function getFileComponentsStreamApi(project_id) {
    return this.streamRequest(config_1.API_DOMAIN + "/" + config_1.API_VER + "/files/" + project_id + "/components");
}
...
function getFileStylesStreamApi(file_key) {
    return this.streamRequest(config_1.API_DOMAIN + "/" + config_1.API_VER + "/files/" + file_key + "/styles");
}
...
function isPaintGradient(paint) {
    return (paint.type === PaintType.GRADIENT_ANGULAR ||
