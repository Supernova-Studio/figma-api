            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        headers = {};
                        this.appendHeaders(headers);
                        axiosParams = __assign(__assign({ url: url }, opts), { headers: headers, responseType: 'stream' });
                        return [4 /*yield*/, (0, axios_1.default)(axiosParams)];
                    case 1:
                        res = _a.sent();
                        if (Math.floor(res.status / 100) !== 2)
...
},{"./api-funcs":2,"./utils":7,"axios":8}],2:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
},{"./config":5,"./utils":7}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
;
;
...
},{"./api-class":1,"./api-types":3,"./ast-types":4,"./config":5}],7:[function(require,module,exports){
"use strict";
