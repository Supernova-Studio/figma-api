...
"use strict";var __assign=this&&this.__assign||function(){return(__assign=Object.assign||function(e){for(var t,i=1,n=arguments.length;i<n;i++)for(var s in t=arguments[i])Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s]);return e}).apply(this,arguments)},__awaiter=this&&this.__awaiter||function(e,t,i,n){return new(i||(i=Promise))(function(s,o){function a(e){try{u(n.next(e))}catch(e){o(e)}}function r(e){try{u(n.throw(e))}catch(e){o(e)}}function u(e){var t;e.done?s(e.value):(t=e.value,t instanceof i?t:new i(function(e){e(t)})).then(a,r)}u((n=n.apply(e,t||[])).next())})},__generator=this&&this.__generator||function(e,t){var i,n,s,o,a={label:0,sent:function(){if(1&s[0])throw s[1];return s[1]},trys:[],ops:[]};return o={next:r(0),throw:r(1),return:r(2)},"function"==typeof Symbol&&(o[Symbol.iterator]=function(){return this}),o;function r(o){return function(r){return function(o){if(i)throw new TypeError("Generator is already executing.");for(;a;)try{if(i=1,n&&(s=2&o[0]?n.return:o[0]?n.throw||((s=n.return)&&s.call(n),0):n.next)&&!(s=s.call(n,o[1])).done)return s;switch(n=0,s&&(o=[2&o[0],s.value]),o[0]){case 0:case 1:s=o;break;case 4:return a.label++,{value:o[1],done:!1};case 5:a.label++,n=o[1],o=[0];continue;case 7:o=a.ops.pop(),a.trys.pop();continue;default:if(!(s=(s=a.trys).length>0&&s[s.length-1])&&(6===o[0]||2===o[0])){a=0;continue}if(3===o[0]&&(!s||o[1]>s[0]&&o[1]<s[3])){a.label=o[1];break}if(6===o[0]&&a.label<s[1]){a.label=s[1],s=o;break}if(s&&a.label<s[2]){a.label=s[2],a.ops.push(o);break}s[2]&&a.ops.pop(),a.trys.pop();continue}o=t.call(e,a)}catch(e){o=[6,e],n=0}finally{i=s=0}if(5&o[0])throw o[1];return{value:o[0]?o[1]:void 0,done:!0}}([o,r])}}},__importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.oAuthToken=exports.oAuthLink=exports.Api=void 0;var api_funcs_1=require("./api-funcs"),axios_1=__importDefault(require("axios")),utils_1=require("./utils"),Api=function(){return function(e){var t=this;this.appendHeaders=function(e){t.personalAccessToken&&(e["X-Figma-Token"]=t.personalAccessToken),t.oAuthToken&&(e.Authorization="Bearer ".concat(t.oAuthToken))},this.request=function(e,i){return __awaiter(t,void 0,void 0,function(){var t,n,s;return __generator(this,function(o){switch(o.label){case 0:return t={},this.appendHeaders(t),n=__assign(__assign({url:e},i),{headers:t}),[4,(0,axios_1.default)(n)];case 1:if(s=o.sent(),2!==Math.floor(s.status/100))throw s.statusText;return i&&i.fullResponse?[2,s]:[2,s.data]}})})},this.streamRequest=function(e,i){return __awaiter(t,void 0,void 0,function(){var t,n,s;return __generator(this,function(o){switch(o.label){case 0:return t={},this.appendHeaders(t),n=__assign(__assign({url:e},i),{headers:t,responseType:"stream"}),[4,(0,axios_1.default)(n)];case 1:if(s=o.sent(),2!==Math.floor(s.status/100))throw s.statusText;return[2,s]}})})},this.headFile=api_funcs_1.headFileApi,this.getFile=api_funcs_1.getFileApi,this.getFileFull=api_funcs_1.getFileFullApi,this.getFileNodes=api_funcs_1.getFileNodesApi,this.getFileStream=api_funcs_1.getFileStreamApi,this.getImage=api_funcs_1.getImageApi,this.getImageFills=api_funcs_1.getImageFillsApi,this.getComments=api_funcs_1.getCommentsApi,this.postComment=api_funcs_1.postCommentsApi,this.deleteComments=api_funcs_1.deleteCommentsApi,this.getMe=api_funcs_1.getUserMeApi,this.getVersions=api_funcs_1.getVersionsApi,this.getTeamProjects=api_funcs_1.getTeamProjectsApi,this.getProjectFiles=api_funcs_1.getProjectFilesApi,this.getTeamComponents=api_funcs_1.getTeamComponentsApi,this.getFileComponents=api_funcs_1.getFileComponentsApi,this.getFileComponentsStream=api_funcs_1.getFileComponentsStreamApi,this.getComponent=api_funcs_1.getComponentApi,this.getTeamComponentSets=api_funcs_1.getTeamComponentSetsApi,this.getFileComponentSets=api_funcs_1.getFileComponentSetsApi,this.getComponentSet=api_funcs_1.getComponentSetApi,this.getTeamStyles=api_funcs_1.getTeamStylesApi,this.getFileStyles=api_funcs_1.getFileStylesApi,this.getFileStylesStream=api_funcs_1.getFileStylesStreamApi,this.getStyle=api_funcs_1.getStyleApi,"personalAccessToken"in e&&(this.personalAccessToken=e.personalAccessToken),"oAuthToken"in e&&(this.oAuthToken=e.oAuthToken)}}();function oAuthLink(e,t,i,n,s){var o=(0,utils_1.toQueryParams)({client_id:e,redirect_uri:t,scope:i,state:n,response_type:s});return"https://www.figma.com/oauth?".concat(o)}function oAuthToken(e,t,i,n,s){return __awaiter(this,void 0,void 0,function(){var o,a,r;return __generator(this,function(u){switch(u.label){case 0:return o=(0,utils_1.toQueryParams)({client_id:e,client_secret:t,redirect_uri:i,code:n,grant_type:s}),a="https://www.figma.com/api/oauth/token?".concat(o),[4,(0,axios_1.default)({url:a,method:"POST"})];case 1:if(200!==(r=u.sent()).status)throw r.statusText;return[2,r.data]}})})}exports.Api=Api,exports.oAuthLink=oAuthLink,exports.oAuthToken=oAuthToken;

},{"./api-funcs":2,"./utils":7,"axios":8}],2:[function(require,module,exports){
"use strict";var __assign=this&&this.__assign||function(){return(__assign=Object.assign||function(t){for(var e,n=1,o=arguments.length;n<o;n++)for(var i in e=arguments[n])Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i]);return t}).apply(this,arguments)},__awaiter=this&&this.__awaiter||function(t,e,n,o){return new(n||(n=Promise))(function(i,s){function c(t){try{a(o.next(t))}catch(t){s(t)}}function r(t){try{a(o.throw(t))}catch(t){s(t)}}function a(t){var e;t.done?i(t.value):(e=t.value,e instanceof n?e:new n(function(t){t(e)})).then(c,r)}a((o=o.apply(t,e||[])).next())})},__generator=this&&this.__generator||function(t,e){var n,o,i,s,c={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return s={next:r(0),throw:r(1),return:r(2)},"function"==typeof Symbol&&(s[Symbol.iterator]=function(){return this}),s;function r(s){return function(r){return function(s){if(n)throw new TypeError("Generator is already executing.");for(;c;)try{if(n=1,o&&(i=2&s[0]?o.return:s[0]?o.throw||((i=o.return)&&i.call(o),0):o.next)&&!(i=i.call(o,s[1])).done)return i;switch(o=0,i&&(s=[2&s[0],i.value]),s[0]){case 0:case 1:i=s;break;case 4:return c.label++,{value:s[1],done:!1};case 5:c.label++,o=s[1],s=[0];continue;case 7:s=c.ops.pop(),c.trys.pop();continue;default:if(!(i=(i=c.trys).length>0&&i[i.length-1])&&(6===s[0]||2===s[0])){c=0;continue}if(3===s[0]&&(!i||s[1]>i[0]&&s[1]<i[3])){c.label=s[1];break}if(6===s[0]&&c.label<i[1]){c.label=i[1],i=s;break}if(i&&c.label<i[2]){c.label=i[2],c.ops.push(s);break}i[2]&&c.ops.pop(),c.trys.pop();continue}s=e.call(t,c)}catch(t){s=[6,t],o=0}finally{n=i=0}if(5&s[0])throw s[1];return{value:s[0]?s[1]:void 0,done:!0}}([s,r])}}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.getStyleApi=exports.getFileStylesStreamApi=exports.getFileStylesApi=exports.getTeamStylesApi=exports.getComponentSetApi=exports.getFileComponentSetsApi=exports.getTeamComponentSetsApi=exports.getComponentApi=exports.getFileComponentsStreamApi=exports.getFileComponentsApi=exports.getTeamComponentsApi=exports.getProjectFilesApi=exports.getTeamProjectsApi=exports.getVersionsApi=exports.getUserMeApi=exports.deleteCommentsApi=exports.postCommentsApi=exports.getCommentsApi=exports.getImageFillsApi=exports.getImageApi=exports.getFileNodesApi=exports.headFileApi=exports.getFileFullApi=exports.getFileStreamApi=exports.getFileApi=void 0;var config_1=require("./config"),utils_1=require("./utils");function getFileApiOptionsToQueryString(t){return(0,utils_1.toQueryParams)(__assign(__assign({},t),{ids:t&&t.ids&&t.ids.join(",")}))}function getFileApi(t,e){return __awaiter(this,void 0,void 0,function(){var n;return __generator(this,function(o){return n=getFileApiOptionsToQueryString(e),[2,this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"?").concat(n))]})})}function getFileStreamApi(t,e){return __awaiter(this,void 0,void 0,function(){var n;return __generator(this,function(o){return n=getFileApiOptionsToQueryString(e),[2,this.streamRequest("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"?").concat(n))]})})}function getFileFullApi(t,e){return __awaiter(this,void 0,void 0,function(){var n,o;return __generator(this,function(i){switch(i.label){case 0:return n=getFileApiOptionsToQueryString(e),[4,this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"?").concat(n),{method:"GET",fullResponse:!0})];case 1:return[2,{data:(o=i.sent()).data,headers:o.headers}]}})})}function headFileApi(t,e){return __awaiter(this,void 0,void 0,function(){var n;return __generator(this,function(o){switch(o.label){case 0:return n=(0,utils_1.toQueryParams)(e),[4,this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"?").concat(n),{method:"HEAD",fullResponse:!0})];case 1:return[2,o.sent().headers]}})})}function getFileNodesApi(t,e,n){var o=(0,utils_1.toQueryParams)(__assign(__assign({},n),{ids:e.join(",")}));return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/nodes?").concat(o))}function getImageApi(t,e){var n=(0,utils_1.toQueryParams)(e);return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/images/").concat(t,"?").concat(n))}function getImageFillsApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/images"))}function getCommentsApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/comments"))}function postCommentsApi(t,e,n,o){var i=o?{message:e,client_meta:n,comment_id:o}:{message:e,client_meta:n};return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/comments"),{method:"POST",data:i})}function deleteCommentsApi(t,e){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/comments/").concat(e),{method:"DELETE",data:""})}function getUserMeApi(){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/me"))}function getVersionsApi(t,e,n,o){void 0===o&&(o=30);var i=(0,utils_1.toQueryParams)({before:n,after:e,page_size:o});return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/versions?").concat(i))}function getTeamProjectsApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/teams/").concat(t,"/projects"))}function getProjectFilesApi(t,e){var n=(0,utils_1.toQueryParams)(e);return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/projects/").concat(t,"/files?").concat(n))}function getTeamComponentsApi(t,e){void 0===e&&(e={});var n=(0,utils_1.toQueryParams)(e);return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/teams/").concat(t,"/components?").concat(n))}function getFileComponentsApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/components"))}function getFileComponentsStreamApi(t){return this.streamRequest("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/components"))}function getComponentApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/components/").concat(t))}function getTeamComponentSetsApi(t,e){void 0===e&&(e={});var n=(0,utils_1.toQueryParams)(e);return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/teams/").concat(t,"/component_sets?").concat(n))}function getFileComponentSetsApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/component_sets"))}function getComponentSetApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/component_sets/").concat(t))}function getTeamStylesApi(t,e){void 0===e&&(e={});var n=(0,utils_1.toQueryParams)(e);return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/teams/").concat(t,"/styles?").concat(n))}function getFileStylesApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/styles"))}function getFileStylesStreamApi(t){return this.streamRequest("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/files/").concat(t,"/styles"))}function getStyleApi(t){return this.request("".concat(config_1.API_DOMAIN,"/").concat(config_1.API_VER,"/styles/").concat(t))}exports.getFileApi=getFileApi,exports.getFileStreamApi=getFileStreamApi,exports.getFileFullApi=getFileFullApi,exports.headFileApi=headFileApi,exports.getFileNodesApi=getFileNodesApi,exports.getImageApi=getImageApi,exports.getImageFillsApi=getImageFillsApi,exports.getCommentsApi=getCommentsApi,exports.postCommentsApi=postCommentsApi,exports.deleteCommentsApi=deleteCommentsApi,exports.getUserMeApi=getUserMeApi,exports.getVersionsApi=getVersionsApi,exports.getTeamProjectsApi=getTeamProjectsApi,exports.getProjectFilesApi=getProjectFilesApi,exports.getTeamComponentsApi=getTeamComponentsApi,exports.getFileComponentsApi=getFileComponentsApi,exports.getFileComponentsStreamApi=getFileComponentsStreamApi,exports.getComponentApi=getComponentApi,exports.getTeamComponentSetsApi=getTeamComponentSetsApi,exports.getFileComponentSetsApi=getFileComponentSetsApi,exports.getComponentSetApi=getComponentSetApi,exports.getTeamStylesApi=getTeamStylesApi,exports.getFileStylesApi=getFileStylesApi,exports.getFileStylesStreamApi=getFileStylesStreamApi,exports.getStyleApi=getStyleApi;
